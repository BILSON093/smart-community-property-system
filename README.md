...
本项目采用 [Source Available Non-Commercial License v1.0](LICENSE)（源码可见 - 非商业使用授权）。
...
**禁止（未经作者书面授权）：**
- 销售、许可、转授权本软件或衍生作品
- 将本软件作为付费产品或服务的一部分进行分发
- 使用本软件提供付费服务
- 发布产生广告、订阅、内购、赞助或其他商业收入的衍生版本
- 在公司或组织内部用于商业运营

**注意：** 本协议非 OSI 认可的开源许可证。项目定位为"源码公开、免费学习、商业需授权"。
